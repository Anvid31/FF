...
<div class="col-xs-12">
    ...
    <br>
      ...
      <a class="btn btn-success" href="../views/newrestaur.php">Crear restaurant
      <i class="fa fa-plus"></i> </a>
		</div>
		<br>
...
?>
                            <section>
                                <img src="../img/descarga.png" alt="1">
                                <img src="../img/images (1).png" alt="2">
                                <img src="../img/images (2).png" alt="3">
                                <img src="../img/images (3).png" alt="4">
                                <img src="../img/images.png" alt="5">
                            </section>  
  </body>
  </table>
